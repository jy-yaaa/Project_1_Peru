...
replace percapitaconsumption =. if training == 0
replace lnpercapitaconsumption =.  if training == 0
...
outsheet lnpercapitaconsumption d_* training percapitaconsumption ///
 poor h_hhsize id_for_matlab hhid lncaphat_OLS percapitahat_OLS ///
 using peru_for_ml_course.csv , comma replace
